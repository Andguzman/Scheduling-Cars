...
CEcond_t road_cond;
CEmutex_t queue_mutex; // For managing the ready queue safely
...
typedef struct {
    ...
    CEmutex_t mutex;         // Mutex for queue operations
} CarQueue;
